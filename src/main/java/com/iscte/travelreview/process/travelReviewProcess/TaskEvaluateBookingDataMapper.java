...
public interface TaskEvaluateBookingDataMapper {
    ...
    @Mapping(target = "accommodationBookingReview", source = "accommodationBookingReview")
    @Mapping(target = "bookingScore", source = "bookingScore")
