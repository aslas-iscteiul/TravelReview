...
public class TravelReview implements Serializable {
    ...
    public Score getBookingScore() {
        return this.bookingScore;
    }

    public TravelReview bookingScore(Score score) {
        this.setBookingScore(score);
        return this;
    }

    public void setBookingScore(Score score) {
        this.bookingScore = score;
    }
    ...
    public TravelReview attraction(Attraction attraction) {
    ...
    public Score getAttractionScore() {
        return this.attractionScore;
    }

    public TravelReview attractionScore(Score score) {
        this.setAttractionScore(score);
        return this;
    }

    public void setAttractionScore(Score score) {
