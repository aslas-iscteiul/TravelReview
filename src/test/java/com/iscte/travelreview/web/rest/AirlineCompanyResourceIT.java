...
import com.iscte.travelreview.repository.AirlineCompanyRepository;
import com.iscte.travelreview.service.dto.AirlineCompanyDTO;
import com.iscte.travelreview.service.mapper.AirlineCompanyMapper;
...
class AirlineCompanyResourceIT {
    ...
    private static final LocalDate DEFAULT_FOUNDATION = LocalDate.ofEpochDay(0L);
    private static final LocalDate UPDATED_FOUNDATION = LocalDate.now(ZoneId.systemDefault());
    ...
    void createAirlineCompany() throws Exception {
        ...
        assertThat(testAirlineCompany.getHeadquarters()).isEqualTo(DEFAULT_HEADQUARTERS);
        assertThat(testAirlineCompany.getFoundation()).isEqualTo(DEFAULT_FOUNDATION);
    }
    ...
    void getAllAirlineCompanies() throws Exception {
        ...
        restAirlineCompanyMockMvc
            ...
            .andExpect(jsonPath("$.[*].foundation").value(hasItem(DEFAULT_FOUNDATION.toString())));
    }
    ...
    void getAirlineCompany() throws Exception {
        ...
        restAirlineCompanyMockMvc
            ...
            .andExpect(jsonPath("$.foundation").value(DEFAULT_FOUNDATION.toString()));
    }
    ...
    void putNewAirlineCompany() throws Exception {
        ...
        assertThat(testAirlineCompany.getHeadquarters()).isEqualTo(UPDATED_HEADQUARTERS);
        assertThat(testAirlineCompany.getFoundation()).isEqualTo(UPDATED_FOUNDATION);
    }
    ...
    void partialUpdateAirlineCompanyWithPatch() throws Exception {
        ...
        partialUpdatedAirlineCompany.name(UPDATED_NAME).website(UPDATED_WEBSITE).foundation(UPDATED_FOUNDATION);
